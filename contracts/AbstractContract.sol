...
/**
 * SunuToken token smart contract.
 */
contract SunuTokenToken is AbstractToken {
  /**
  ...
  /**
   * Create new SunuToken token smart contract, with given number of tokens issued
   ...
   */
  function SunuTokenToken (uint256 _tokenCount) {
    owner = msg.sender;
